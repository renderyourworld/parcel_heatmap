...
type ImportCheckpoint struct {
	...
	CountyName      string     `gorm:"type:varchar(50);not null;uniqueIndex:idx_county_import"`
	ImportType      string     `gorm:"type:varchar(20);not null;uniqueIndex:idx_county_import"`
